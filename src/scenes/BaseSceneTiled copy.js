...
export default class BaseSceneTiled extends BaseScene{
    ...
    spawnEnemies(){
        ...
        if (!enemyObjectLayer) return;

        this.enemyGroup = this.add.group({runChildUpdate: true});

        enemyObjectLayer.objects.forEach(object => {
            // console.log(object);
            switch(object.name){
                case "saw":
                    this.createSaw(object);
                break;
                default:
    ...
    createSaw(object){
        console.log(object);
        let newSaw = new Saw(this, object.x, object.y, object);
        this.enemyGroup.add(newSaw);
    }
}